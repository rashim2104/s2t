  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (generateTokenResponse.ok) {
        ...
        if (generateTokenData && generateTokenData.message) {
          setStart(generateFormattedToken(generateTokenData.message.schoolId, generateTokenData.message.firstToken));
          setEnd(generateFormattedToken(generateTokenData.message.schoolId, generateTokenData.message.lastToken));
          setTstart(generateFormattedTokenTeacher(generateTokenData.message.schoolId, generateTokenData.message.tFirstToken));
          setTend(generateFormattedTokenTeacher(generateTokenData.message.schoolId, generateTokenData.message.tLastToken));
          setDeskDetails(generateTokenData.deskDetails);
          ...
          console.log('School Details:', generateTokenData.schoolDetails);
          console.log('Projects:', { junior: generateTokenData.sProjects, young: generateTokenData.yProjects });
        } else {
                  ...
                  <div style={{
                    ...
                    {juniorProjects.length > 0 && (
                      <div style={{ marginBottom: "15px" }}>
                        <h4 style={{ margin: "0 0 10px 0", color: "#0b4685" }}>Junior Scientists</h4>
                    ...
                    {youngProjects.length > 0 && (
                      <div>
                        <h4 style={{ margin: "0 0 10px 0", color: "#0b4685" }}>Young Scientists</h4>
